...
@section('content')
  <div class="h-100 bg-white">
    <div class="row h-100 m-0 p-0">
      <div class="col-3 h-100 m-0 p-0 border-start border-end border-gray">
        ...
        <div class="left-memo-title h3 ps-3 pt-3">
          メモリスト
        </div>
      ...
      <div class="col-9 h-100">
        @if ($select_memo)
          <form class="w-100 h-100" method="post">
            ...
            <div id="memo-menu">
              <button type="submit" class="btn btn-danger" formaction="{{ route('memo.delete') }}"><i
                  class="fas fa-trash-alt"></i></button>
              <button type="submit" class="btn btn-success" formaction="{{ route('memo.update') }}"><i
